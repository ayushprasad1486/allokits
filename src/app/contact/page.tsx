              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Ramgarh, Jharkhand, India - 829102 (Remote)</p>
                  </div>
                </div>
            ...
            <GlassmorphismCard className="p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-white">Swift Delivery</h4>
                    <p className="text-gray-400 text-sm">
                      Prompt project completion while maintaining top-notch quality.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Meticulously crafted edits with a focus on professional polish.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Consistent updates and a clear, engaging process throughout.
                    </p>
                  </div>
                </div>
              </div>
