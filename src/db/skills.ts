...
export const videoEditingSkills = [
  {
    ...
    icon: Film,
    description:
      "Professional motion graphics, editing, and audio post-production",
  ...
  {
    name: "Canva",
    image_link: "/tools/logo-canva-png.png",
    icon: Volume2,
    description: "Poster making, logo design, and graphic designs",
    color: "text-green-400",
  }, {
    name: "Social Media Content Creation",
    image_link: "/tools/Camera.jpg",
    icon: Volume2,
    description: "expertise on content creation,35k+ Followers on Instagram",
    color: "text-green-400",
  },
];
...
export const achievements = [
  ...
  },
  {
    ...
    description:
      "Having expertise on content creation, 35k+ Followers on Instagram",
    icon: CameraIcon,
    color: "text-red-400",
  },
  {
