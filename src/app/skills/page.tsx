      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 text-base md:text-lg max-w-3xl mx-auto">
            Skilled video editor and passionate content creator with a strong background in electronics. Offering professional video editing services to bring your vision to life with high-quality, captivating edits. Dedicated to enhancing your projects with creativity and precision. Let’s collaborate to make your ideas shine!
          </p>
        </motion.div>
        ...
        <CTASection
          ...
          description="Ready to elevate your project? Let’s connect to explore your video editing goals and craft visually stunning content with professional precision and creative energy."
