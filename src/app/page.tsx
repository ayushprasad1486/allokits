        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto mb-8">
              With seamless transitions, flawless audio synchronization, and vibrant animations, I transform your content into compelling stories that captivate and inspire.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto">
              Need a video editor who combines creative flair with technical expertise, ensures clear communication, and is passionate about elevating your content? I’m the one for the job.
            </p>
          </motion.div>
